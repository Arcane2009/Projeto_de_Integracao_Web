...
CREATE TABLE `animal1` (
  ...
  KEY `FK_CPF` (`CPF`),
  CONSTRAINT `FK_CPF` FOREIGN KEY (`CPF`) REFERENCES `cliente1` (`CPF`)
...
INSERT INTO `animal1` VALUES (NULL,'Jorge','Coelho','1 ano','petshop','https://thumb.wikimedia.org/wikipedia/commons/thumb/3/37/Oryctolagus_cuniculus_Tasmania_2.jpg/960px-Oryctolagus_cuniculus_Tasmania_2.jpg?utm_source=pt.wikipedia.org&utm_campaign=imageinfo&utm_content=thumbnail');
...
CREATE TABLE `cliente1` (
  ...
  `IDADE_USER` varchar(20) DEFAULT NULL,
...
INSERT INTO `cliente1` VALUES ('12233344509','Pedro','13 anos','(43) 99108-4682');
...
-- Dump completed on 2026-09-24  9:52:10
